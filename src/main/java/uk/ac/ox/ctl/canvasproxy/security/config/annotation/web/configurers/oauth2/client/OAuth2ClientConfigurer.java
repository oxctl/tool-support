 ...
 */
package uk.ac.ox.ctl.canvasproxy.security.config.annotation.web.configurers.oauth2.client;
...
import uk.ac.ox.ctl.canvasproxy.security.oauth2.client.web.OAuth2AuthorizationRequestRedirectFilter;
...
public final class OAuth2ClientConfigurer<B extends HttpSecurityBuilder<B>> extends
	...
	public class AuthorizationCodeGrantConfigurer {
		...
		private void configure(B builder) {
			...
			builder.addFilterAfter(postProcess(authorizationRequestRedirectFilter), LogoutFilter.class);
