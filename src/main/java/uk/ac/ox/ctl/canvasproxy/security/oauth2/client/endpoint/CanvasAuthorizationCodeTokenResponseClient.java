 ...
 * 
 * This class is needed because of https://github.com/spring-projects/spring-security/issues/12112 where if no scopes
 * are returned Spring Security no longer assumes that all the scopes that were requested were granted.
 * This is related to https://spring.io/security/cve-2022-31690 This doesn't affect us, as we are only using scopes
 * to work out if the user needs to be prompted to re-authorize the application.
 *
 * @author Joe Grandja
 * @since 5.1
 ...
 * (Authorization Code Grant)</a>
 */
public final class CanvasAuthorizationCodeTokenResponseClient
	...
	public CanvasAuthorizationCodeTokenResponseClient() {
